  ...
  return (
    <div className="relative flex h-full flex-col items-center justify-end">
      {isIncomingCameraOn === false ? (
        <div className="absolute top-0 left-0 z-10 flex h-full w-full items-center justify-center rounded-4xl bg-[url(public/images/login-bg.png)] bg-cover bg-right-top">
